          ...
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div class="addr-info" :class="{'checked':index==checkIndex}" @click="checkIndex=index" v-for="(item,index) in list" :key="index">
                ...
                <div class="street">{{item.receiverProvince+' '+item.receiverCity+' '+item.receiverDistrict+' '+item.receiverAddress}}<br>{{item.receiverZip}}</div>
                <div class="action">
                  <a href="javascript:;" class="fl"  @click="delAddress(item.id)">
        ...
        submitAddress(){
            ...
            if(userAction==0||userAction==1){
              ...
              if(!receiverName){
                ...
                errMsg='请输入正确的城市';
              }else if(!receiverDistrict||!receiverDistrict){
                errMsg='请输入收货地址';
